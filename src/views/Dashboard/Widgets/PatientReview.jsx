    ...
    <article className="p-1">
      <div className="p-2 flex flex-col gap-2 rounded-lg bg-gray-100">
        ...
        <p className="text-gray-800 text-sm line-clamp-3">
          The staff was very friendly and the service was prompt. The doctor was
          attentive and answered all my questions thoroughly. However, I had to
          wait a bit longer than expected for my appointment.
        </p>
      </div>
    </article>
  );
