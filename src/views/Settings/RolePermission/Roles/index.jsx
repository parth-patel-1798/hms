...
const Roles = () => {
    ...
    const hasEditPermission = checkPermission('role-edit');
    const hasDeletePermission = checkPermission('role-delete');
    return (
                    ...
                    <table className="min-w-full bg-white border-gray-300">
                        <thead className="text-sm font-normal w-full bg-gray-200">
                            <tr className="text-left">
                                ...
                                <th className="p-2 font-semibold text-right">User Count</th>
                        ...
                        <tbody>
                            {isLoading ? (
                                <tr className="">
                                    <td className="text-center pt-2 text-sm" colSpan="4">
                                        Loading ...
                                    </td>
                                </tr>
                            ) : (
